...
In addition to applying our model to estimate the effects of the Republic/Santek merger on the Chattanooga market, in this section we simulate the effects of the hypothetical mergers of three other pairs (Santek/Waste Connections, Santek/WM-ADS, and WM-ADS/Regional) that would have resulted in companies with different vertical supply configurations combining. The estimated aggregate welfare effects of these counterfactual mergers are illustrated alongside those of the Republic/Santek merger in Figure \ref{fig:TrashFakeOverall}.

The pre-merger Herfindahl-Hirschman Index (HHI) for the Chattanooga disposal market is 2,646 and collection market is 3,035. The merger of WM-ADS with the Regional collection firm is a straightforward ``horizontal'' merger between two relatively small downstream competitors. This merger results in a post-merger change in the collection market HHI of 136s. Unsurprisingly, the resulting estimated welfare effects are small and consumer harm and producer benefits approximately cancel each other out. The more detailed results reported in Figure \ref{fig:TrashFakeFirms} show only minimal changes in prices or collection shares post-merger.

Turning to the Santek/WM-ADS merger simulation, we consider the effects of a small downstream rival combining with a vertically integrated firm. Here the merger results in a post-merger change in the collection market HHI of 620, but consumer harm from increased collection prices of 1.3\% is significantly dampened by price decreases in collection of 2.4\% from EDM. This results in net consumer harm of approximately \$1.5 million.

Finally, we examine the potential merger of Santek and Waste Connections. While this merger is similar to that of Santek and Republic in that it is a merger between vertically integrated rivals, Santek/WasteConn differs in it's effects on the Chattanooga market because both parties exclusively self-supplied for their disposal input pre-merger. This diminishes the possibility for EDM effects. In addition, while Santek/WasteConn significantly raise disposal prices to their downstream rivals, the presence of the larger, vertically integrated (even if capacity constrained) Republic limits the merged firm's ability to pass this through to the collection market. Thus, net consumer harm to the Chattanooga market remains relatively small at \$6.6 million. This is in spite of post-merger changes in the HHIs of the disposal market of 1,896 and collection market of 620.

\subsection{Robustness}

The robustness of our simulation results depends critically on a few key parameter values. One of these is the assumption of the bargaining power parameter, $\lambda$. \citeN{ST2021} shows that mergers tend to benefit consumers when wholesalers have relatively more power, and harm consumers when retailers have relatively more power. Larger wholesaler bargaining power offers more possibilities for EDM, as pre-merger input prices are likely to be high. This channel becomes less relevant as retailers gain more power. Figure \ref{fig:TrashBarg} illustrates his relationship between consumer welfare and the value of the bargaining power parameter for the Republic/Santek merger simulation. Harm increases rapidly as bargaining power increases to $0.4$ and then becomes nearly constant for values above $0.5$. Thus, assuming an equal split between collection and disposal would yield an estimate of a near upper bound on consumer harm for this merger.
...
%`All' changes the bargaining power parameter for all non-vertically integrated firms. `Santek:Republic' changes the bargaining power parameter for just the Santek/Republic product. `WasteConn:Republic' changes the bargaining power parameter for just the WasteConn:Republic product. The Dashed line displays baseline results.
}
