...
\begin{figure}
\centering
\caption{The sensitivity of the Republic/Santek simulation results to changes in the outside share. The absolute value of the market elasticity corresponding to the change in ouside share is in parentheses. Baseline results assume 0 outside share.}
